...
namespace kunif.EscPosUtils
{
    ...
    public static partial class EscPosDecoder
    {
        ...
        ///
        /// </summary>
        private static readonly Dictionary<EscPosCmdType, DecInfo?> s_DecodeType = new Dictionary<EscPosCmdType, DecInfo?>()
        {
            ...
            {   EscPosCmdType.EscAbsoluteVerticalPosition, new DecInfo { decodedetail = new DecodeDetail(DecodeValueUInt16), index = 2, trailer = " dots" } },                          //  ESC $   1B 24 0000-FFFF
            ...
            {   EscPosCmdType.EscSetRelativeHprizontalPrintPosition, new DecInfo { decodedetail = new DecodeDetail(DecodeValueSInt16), index = 2, trailer = " dots" } },                //  ESC \   1B 5C 8000-7FFF
            ...
            {   EscPosCmdType.GsSetAbsoluteVerticalPrintPositionInPageMode, new DecInfo { decodedetail = new DecodeDetail(DecodeValueUInt16), index = 2, trailer = " dots" } },                             //c GS  $   1D 24 0000-FFFF
            {   EscPosCmdType.GsSetAbsoluteVerticalPrintPosition, new DecInfo { decodedetail = new DecodeDetail(DecodeValueUInt16), index = 2, trailer = " dots" } },                                       //  GS  &   1D 26 0000-FFFF
            ...
            {   EscPosCmdType.GsSetCustomizeSettinValues, new DecInfo { decodedetail = new DecodeDetail(DecodeGsSetCustomizeSettinValues), index = 3 } },                                                   //  GS  ( E 1D 28 45 0004-FFFD 05 [01-03/05-0D/14-16/46-48/61/62/64-69/6F/70/74-C2 0000-FFFF]...
            ...
            {   EscPosCmdType.Gs2DGS1DBSetWidthOfModule, new DecInfo { decodedetail = new DecodeDetail(DecodeGs2DGS1DBSetWidthOfModule), index = 7 } },                                                     //  GS  ( k 1D 28 6B 03 00 33 43 02-08
            {   EscPosCmdType.Gs2DGS1DBSetExpandStackedMaximumWidth, new DecInfo { decodedetail = new DecodeDetail(DecodeGs2DGS1DBSetExpandStackedMaximumWidth), index = 7 } },                             //  GS  ( k 1D 28 6B 04 00 33 47 0000/006A-0F70
            {   EscPosCmdType.Gs2DGS1DBStoreData, new DecInfo { decodedetail = new DecodeDetail(DecodeGs2DGS1DBStoreData), index = 3 } },                                                                   //  GS  ( k 1D 28 6B 0006-0103 33 50 30 20-22/25-2F/30-39/3A-3F/41-5A/61-7A...
            {   EscPosCmdType.Gs2DGS1DBPrintSymbolData, null },                                                                                                                                             //  GS  ( k 1D 28 6B 03 00 33 51 30
            {   EscPosCmdType.Gs2DGS1DBTransmitSizeInformation, null },                                                                                                                                     //  GS  ( k 1D 28 6B 03 00 33 52 30
